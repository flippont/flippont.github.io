...
function createCanvasState(canvas, imageIdx) {
    ...
    class centerPiece extends Entity {
        constructor(drawOnceCallback) {
            ...
            this.imageSprite.src = "./src/blog/images/" + this.currentImage;
            this.photoW = 180;
            this.photoH = 240;
        ...
        setImage(imgName) {
            ...
            this.imageSprite.src = "./src/blog/images/" + imgName;
    ...
    class FramedPhoto extends centerPiece {
        constructor(drawOnceCallback) {
            ...
            this.pedestalImg.src = "./src/blog/images/pedestal.png";
            this.title = imageList[imageIdx].title;
            this.creationDate = imageList[imageIdx].creationDate;
            this.frameImg = new Image();
            this.frameImg.src = "./src/blog/images/frame.png";
    ...
    class Pole extends Entity {
        constructor(x, y) {
            ...
            if (!Pole.poleImg) {
                ...
                Pole.poleImg.src = "./src/blog/images/pole.png";
                Pole.poleImg.onload = () => {
    ...
    class NPC extends Entity {
        constructor(cx, cy, stopX, stopY, label) {
            ...
            this.imageSprite = new Image();
            this.currentImage = imageList[imageIdx].src;
            this.imageSprite.src = "./src/blog/images/" + label; // Placeholder NPC image
